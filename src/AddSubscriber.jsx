      ...
      <div>
        ...
        <div className='content-container'>
          ...
          <form className='subscriber-form'>
            ...
            <br />
            <input name='name' type='text' placeholder='Name' className='input-control' onChange={this.inputChangedHandler}/>
            <br />
            <label htmlFor='phone' className='label-control'>Phone: </label>
            <br />
            <input name='phone' type='text' placeholder='Phone' className='input-control' onChange={this.inputChangedHandler}/>
            <br />
